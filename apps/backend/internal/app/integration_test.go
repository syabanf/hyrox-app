...
func truncateAll(t *testing.T, db *database.DB) {
	...
	_, err := db.Exec(context.Background(), `
		TRUNCATE
			...
			pos.receipt_sends, pos.print_jobs, pos.receipt_settings,
			pos.gift_card_entries, pos.gift_cards,
			pos.order_promotions, pos.promotion_targets, pos.promotions,
			...
			purchasing.vendor_credits, purchasing.payment_terms,
			purchasing.delivery_items, purchasing.deliveries,
